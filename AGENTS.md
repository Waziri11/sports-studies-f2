# Sport Studies for Secondary Schools: Student's Book Form Two — ADT Bundle Reference
...
**Sport Studies for Secondary Schools: Student's Book Form Two** — This is an English-language Sport Studies student textbook for Form Two secondary school learners in Tanzania, published by the Tanzania Institute of Education and aligned with the 2023 national syllabus. It covers practical and theoretical foundations of netball, athletics field events, swimming, and gymnastics, with strong emphasis on safety precautions, rules, techniques, equipment, and position-specific or event-specific skills. The book appears aimed at lower secondary students and uses a competency-based, activity-driven approach, combining explanations, illustrations, drills, revision exercises, and projects to build physical skills, discipline, teamwork, and confidence.
...
├── SPORTS-STUDIES-FORM-TWO.db                    # SQLite database (pipeline state)
├── SPORTS-STUDIES-FORM-TWO.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, for Sport Studies for Secondary Schools Student’s Book Form Two, approved as a textbook for Form Two on 31st May 2025, signed by the Commissioner for Education, Dr Lyabwene M. Mtababwa.",
  "gl001": "above-the-ring grip",
  "gl001_def": "A grip used when the gymnast supports the body above the rings instead of hanging below them."
}
```
...
{
  "above-the-ring grip": {
    "word": "above-the-ring grip",
    "definition": "A grip used when the gymnast supports the body above the rings instead of hanging below them.",
    "variations": ["above-the-ring grip","above the ring grip","above-the-ring grips"],
    "emoji": "⭕⬆️✋"
  }
}
```
...
```json
{
  "title": "Sport Studies for Secondary Schools: Student's Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `SPORTS-STUDIES-FORM-TWO.pdf` |
| Pipeline database | `SPORTS-STUDIES-FORM-TWO.db` (SQLite) |
